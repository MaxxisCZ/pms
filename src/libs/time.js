...
export default {
  ...
  timeToStr(val, enCode){
    ...
    return val.format.replace(val.simple ? /([^-_\/.: 0-9])/igm : /([^-_\/.: 0-9]{1,})/igm, ($, $1)=>{
      switch ($1){
        case 'y':
        ...
        case 'M':
          return ['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'][thisDate.getMonth()];
        case 'd':
        case 'D':
        ...
        case 'w':
          return '星期' + ['日','一','二','三','四','五','六'][thisDate.getDay()];
        case 'W':
          return ['Sun','Mon','Tues','Thur','May','Fri','Sat'][thisDate.getDay()];
        default:
